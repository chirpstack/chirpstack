...
const (
	...
	MulticastGroupService_GetRandomDevAddr_FullMethodName = "/api.MulticastGroupService/GetRandomDevAddr"
	MulticastGroupService_AddDevice_FullMethodName        = "/api.MulticastGroupService/AddDevice"
	MulticastGroupService_ListDevices_FullMethodName      = "/api.MulticastGroupService/ListDevices"
	MulticastGroupService_RemoveDevice_FullMethodName     = "/api.MulticastGroupService/RemoveDevice"
	MulticastGroupService_SyncTs005Session_FullMethodName = "/api.MulticastGroupService/SyncTs005Session"
...
type MulticastGroupServiceClient interface {
	...
	// GetRandomDevAddr returns a random DevAddr taking the tenant NwkID prefix
	// configuration into account.
	GetRandomDevAddr(ctx context.Context, in *GetRandomMulticastGroupDevAddrRequest, opts ...grpc.CallOption) (*GetRandomMulticastGroupDevAddrResponse, error)
	...
	// List the devices in the multicast group.
	ListDevices(ctx context.Context, in *ListMulticastGroupDevicesRequest, opts ...grpc.CallOption) (*ListMulticastGroupDevicesResponse, error)
	...
	// SyncTs005Session sends the TS005 McClassB/CSessionReq to devices with
	// completed multicast-group setup.
	SyncTs005Session(ctx context.Context, in *SyncMulticastGroupTs005SessionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *multicastGroupServiceClient) GetRandomDevAddr(ctx context.Context, in *GetRandomMulticastGroupDevAddrRequest, opts ...grpc.CallOption) (*GetRandomMulticastGroupDevAddrResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRandomMulticastGroupDevAddrResponse)
	err := c.cc.Invoke(ctx, MulticastGroupService_GetRandomDevAddr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multicastGroupServiceClient) ListDevices(ctx context.Context, in *ListMulticastGroupDevicesRequest, opts ...grpc.CallOption) (*ListMulticastGroupDevicesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMulticastGroupDevicesResponse)
	err := c.cc.Invoke(ctx, MulticastGroupService_ListDevices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multicastGroupServiceClient) SyncTs005Session(ctx context.Context, in *SyncMulticastGroupTs005SessionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MulticastGroupService_SyncTs005Session_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MulticastGroupServiceServer interface {
	...
	// GetRandomDevAddr returns a random DevAddr taking the tenant NwkID prefix
	// configuration into account.
	GetRandomDevAddr(context.Context, *GetRandomMulticastGroupDevAddrRequest) (*GetRandomMulticastGroupDevAddrResponse, error)
	// Add a device to the multicast group.
	AddDevice(context.Context, *AddDeviceToMulticastGroupRequest) (*emptypb.Empty, error)
	// List the devices in the multicast group.
	ListDevices(context.Context, *ListMulticastGroupDevicesRequest) (*ListMulticastGroupDevicesResponse, error)
	// Remove a device from the multicast group.
	RemoveDevice(context.Context, *RemoveDeviceFromMulticastGroupRequest) (*emptypb.Empty, error)
	// SyncTs005Session sends the TS005 McClassB/CSessionReq to devices with
	// completed multicast-group setup.
	SyncTs005Session(context.Context, *SyncMulticastGroupTs005SessionRequest) (*emptypb.Empty, error)
	// Add a gateway to the multicast group.
...
func (UnimplementedMulticastGroupServiceServer) GetRandomDevAddr(context.Context, *GetRandomMulticastGroupDevAddrRequest) (*GetRandomMulticastGroupDevAddrResponse, error) {
...
func (UnimplementedMulticastGroupServiceServer) ListDevices(context.Context, *ListMulticastGroupDevicesRequest) (*ListMulticastGroupDevicesResponse, error) {
...
func (UnimplementedMulticastGroupServiceServer) SyncTs005Session(context.Context, *SyncMulticastGroupTs005SessionRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncTs005Session not implemented")
}
...
func _MulticastGroupService_GetRandomDevAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRandomMulticastGroupDevAddrRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MulticastGroupServiceServer).GetRandomDevAddr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MulticastGroupService_GetRandomDevAddr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MulticastGroupServiceServer).GetRandomDevAddr(ctx, req.(*GetRandomMulticastGroupDevAddrRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MulticastGroupService_ListDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMulticastGroupDevicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MulticastGroupServiceServer).ListDevices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MulticastGroupService_ListDevices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MulticastGroupServiceServer).ListDevices(ctx, req.(*ListMulticastGroupDevicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MulticastGroupService_SyncTs005Session_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncMulticastGroupTs005SessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MulticastGroupServiceServer).SyncTs005Session(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MulticastGroupService_SyncTs005Session_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MulticastGroupServiceServer).SyncTs005Session(ctx, req.(*SyncMulticastGroupTs005SessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MulticastGroupService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MulticastGroupService_GetRandomDevAddr_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _MulticastGroupService_ListDevices_Handler,
		},
		{
		...
		{
			MethodName: "SyncTs005Session",
			Handler:    _MulticastGroupService_SyncTs005Session_Handler,
		},
		{
