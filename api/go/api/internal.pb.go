...
var file_api_internal_proto_rawDesc = []byte{
	...
	0x68, 0x32, 0x52, 0x06, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x32, 0x22, 0x86, 0x01, 0x0a, 0x0d, 0x4f,
	...
	0x55, 0x72, 0x6c, 0x22, 0x7f, 0x0a, 0x06, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x32, 0x12, 0x18, 0x0a,
	...
	0x74, 0x55, 0x72, 0x6c, 0x22, 0x45, 0x0a, 0x19, 0x4f, 0x70, 0x65, 0x6e, 0x49, 0x64, 0x43, 0x6f,
	...
	0x05, 0x64, 0x72, 0x4d, 0x61, 0x78, 0x32, 0xf8, 0x08, 0x0a, 0x0f, 0x49, 0x6e, 0x74, 0x65, 0x72,
...
func file_api_internal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_internal_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OAuth2LoginRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_internal_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OAuth2LoginResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_internal_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_internal_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_internal_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
