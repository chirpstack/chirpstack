...
type RegionChannel struct {
	...
	// Data-rates.
	DataRates     []uint32 `protobuf:"varint,4,rep,packed,name=data_rates,json=dataRates,proto3" json:"data_rates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegionChannel) GetDataRates() []uint32 {
	if x != nil {
		return x.DataRates
	}
	return nil
...
const file_api_internal_proto_rawDesc = "" +
	...
	"\vdescription\x18\v \x01(\tR\vdescription\"L\n" +
	"\rRegionChannel\x12\x1c\n" +
	"\tfrequency\x18\x01 \x01(\rR\tfrequency\x12\x1d\n" +
	"\n" +
	"data_rates\x18\x04 \x03(\rR\tdataRates\".\n" +
