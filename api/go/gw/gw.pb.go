...
var file_gw_gw_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xe7, 0x04,
	...
	0x5f, 0x4f, 0x4b, 0x10, 0x02, 0x2a, 0xbc, 0x01, 0x0a, 0x0b, 0x54, 0x78, 0x41, 0x63, 0x6b, 0x53,
	...
	0x4f, 0x52, 0x10, 0x0a, 0x42, 0x55, 0x0a, 0x14, 0x69, 0x6f, 0x2e, 0x63, 0x68, 0x69, 0x72, 0x70,
	...
	0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x34, 0x2f, 0x67, 0x77, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_gw_gw_proto_depIdxs = []int32{
	...
	46, // 33: gw.DownlinkTxInfoLegacy.modulation:type_name -> common.Modulation
	9,  // 34: gw.DownlinkTxInfoLegacy.lora_modulation_info:type_name -> gw.LoraModulationInfo
	10, // 35: gw.DownlinkTxInfoLegacy.fsk_modulation_info:type_name -> gw.FskModulationInfo
	1,  // 36: gw.DownlinkTxInfoLegacy.timing:type_name -> gw.DownlinkTiming
	21, // 37: gw.DownlinkTxInfoLegacy.immediately_timing_info:type_name -> gw.ImmediatelyTimingInfo
	22, // 38: gw.DownlinkTxInfoLegacy.delay_timing_info:type_name -> gw.DelayTimingInfo
	23, // 39: gw.DownlinkTxInfoLegacy.gps_epoch_timing_info:type_name -> gw.GPSEpochTimingInfo
	6,  // 40: gw.DownlinkTxInfo.modulation:type_name -> gw.Modulation
	20, // 41: gw.DownlinkTxInfo.timing:type_name -> gw.Timing
	21, // 42: gw.Timing.immediately:type_name -> gw.ImmediatelyTimingInfo
	22, // 43: gw.Timing.delay:type_name -> gw.DelayTimingInfo
	23, // 44: gw.Timing.gps_epoch:type_name -> gw.GPSEpochTimingInfo
	49, // 45: gw.DelayTimingInfo.delay:type_name -> google.protobuf.Duration
	49, // 46: gw.GPSEpochTimingInfo.time_since_gps_epoch:type_name -> google.protobuf.Duration
	7,  // 47: gw.UplinkFrame.tx_info_legacy:type_name -> gw.UplinkTxInfoLegacy
	16, // 48: gw.UplinkFrame.rx_info_legacy:type_name -> gw.UplinkRxInfoLegacy
	8,  // 49: gw.UplinkFrame.tx_info:type_name -> gw.UplinkTxInfo
	17, // 50: gw.UplinkFrame.rx_info:type_name -> gw.UplinkRxInfo
	8,  // 51: gw.UplinkFrameSet.tx_info:type_name -> gw.UplinkTxInfo
	17, // 52: gw.UplinkFrameSet.rx_info:type_name -> gw.UplinkRxInfo
	27, // 53: gw.DownlinkFrame.items:type_name -> gw.DownlinkFrameItem
	18, // 54: gw.DownlinkFrameItem.tx_info_legacy:type_name -> gw.DownlinkTxInfoLegacy
	19, // 55: gw.DownlinkFrameItem.tx_info:type_name -> gw.DownlinkTxInfo
	29, // 56: gw.DownlinkTxAck.items:type_name -> gw.DownlinkTxAckItem
	4,  // 57: gw.DownlinkTxAckItem.status:type_name -> gw.TxAckStatus
	31, // 58: gw.GatewayConfiguration.channels:type_name -> gw.ChannelConfiguration
	49, // 59: gw.GatewayConfiguration.stats_interval:type_name -> google.protobuf.Duration
	46, // 60: gw.ChannelConfiguration.modulation_legacy:type_name -> common.Modulation
	32, // 61: gw.ChannelConfiguration.lora_modulation_config:type_name -> gw.LoraModulationConfig
	33, // 62: gw.ChannelConfiguration.fsk_modulation_config:type_name -> gw.FskModulationConfig
	45, // 63: gw.GatewayCommandExecRequest.environment:type_name -> gw.GatewayCommandExecRequest.EnvironmentEntry
	5,  // 64: gw.ConnState.state:type_name -> gw.ConnState.State
